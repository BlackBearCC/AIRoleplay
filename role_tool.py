...
class MemoryTool(BaseTool):
    name = " Memories, past events, history, dates, experiences, the past, old times, nostalgia, memory"
...
class ActionResponeTool(BaseTool):
    name = "Actions, doing, reactions, decisions, planning, execution, behavior, activities, practice, action guidance."
